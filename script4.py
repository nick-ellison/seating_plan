...
def arrange_seating(people):
    ...
    while attempts > 0:
        ...
        if valid_alternating_seating(seating1) and valid_alternating_seating(seating2) and len(seating1) == 12 and len(seating2) == 12:
            if split_couples > max_split_couples or (split_couples == max_split_couples and total_adjacent_singles > max_adjacent_singles):
    ...
    if best_seating1 and best_seating2:
        print(f"Best arrangement found with {max_split_couples} split couples and {max_adjacent_singles} adjacent singles!")
    else:
